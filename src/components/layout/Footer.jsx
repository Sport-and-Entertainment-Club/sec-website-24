    ...
    <div className="px-0 w-full md:px-[4%] lg:px-[5%] flex flex-col bg-purple text-[7.67px] sm:text-[10px] md:text-[14px] lg:text-[16px] text-white pt-[30px] font-poppins font-[400]">
      <div className="md:grid md:grid-cols-[1fr,1.5fr] lg:grid-cols-[1.5fr,2.5fr]">
        <div className="flex flex-col items-center">
          ...
          />
          <p className=" pt-[20px] leading-[20.34px] md:leading-[32px] text-center max-w-[60%] md:max-w-[80%]">
        ...
        <div className="hidden px-[30px] lg:px-[30px] xl:px-[50px] md:grid grid-cols-3 justify-between pt-[65px]">
          <div className="flex flex-col">
            <p className=" py-[20px]  font-[600] xl:text-[24px] lg:text-[22px] text-[18px] font-montserrat ">
              About Us
            </p>
            <p className="py-[6px] xl:py-[8px]">About</p>
            <p className="py-[6px] xl:py-[8px]">Goals and vision</p>
          </div>
          <div className="flex flex-col">
            <p className=" py-[20px]  font-[600] xl:text-[24px] lg:text-[22px] text-[18px] font-montserrat ">
              Our Team
            </p>
            <p className="py-[6px] xl:py-[8px]">Team</p>
          </div>
          <div className="flex flex-col">
            <p className=" py-[20px]  font-[600] xl:text-[24px] lg:text-[22px] text-[18px] font-montserrat ">
              Events & Activities
            </p>
            <p className="py-[6px] xl:py-[8px]">Events</p>
            <p className="py-[6px] xl:py-[8px]">Activities</p>
          </div>
        </div>
      </div>
      <p className="text-center py-[14.39px] md:py-[30px]  border-t-bg-white border-t-[1px]">
